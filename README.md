...
Once the `conda-forge` channel has been enabled, `pygaps` can be installed with:

```
conda install pygaps
```

It is possible to list all of the versions of `pygaps` available on your platform with:
